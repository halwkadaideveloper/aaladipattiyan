...
export const Colors = {
  light: {
    ...
    iconPink: "#EFA937",
    radioColor: "#FFF",
    radioOuterColor: "#EFA937",
    spinnerColor: "#EFA937",
    orderComplete: "#89a207",
    orderUncomplete: "#fe0000",
    horizontalLine: "#B8B8B8",
    buttonBackground: "#EFA937",
    buttonText: "black",
    buttonBackgroundPink: "#EFA937",
    buttonTextPink: "#FFF",
  ...
  dark: {
    ...
    buttonBackground: "#EFA937", // Darker green for buttons
